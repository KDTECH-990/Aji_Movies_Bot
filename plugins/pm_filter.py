...
async def next_page(bot, query):
    ...
    btn.insert(1,
        [
            ...
            InlineKeyboardButton(f' Info', 'minfo')
        ]
    )    
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("⌫𝗕𝗮𝗰𝗸", callback_data=f"next_{req}_{key}_{off_set}"),
             InlineKeyboardButton(f"⎙𝗣𝗮𝗴𝗲 {math.ceil(int(offset) / 10) + 1} / {math.ceil(total / 10)}",
                                  callback_data="pages")]
        )
    elif off_set is None:
        btn.append(
    ...
    if query.data.startswith("file"):        
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  InlineKeyboardButton('🔰 Main Group 🔰', url="https://t.me/+iEbhY7mM4oE1OTVl")
                 ]
                ]
            )
        )                 
        ...
        buttons = [[                     
            ...
            InlineKeyboardButton('𝚂𝙷𝙰𝚁𝙴_𝚃𝙴𝚇𝚃​', callback_data='sharetxt')
            ],[
            InlineKeyboardButton('‹‹ 𝙱𝙰𝙲𝙺', callback_data='start'),
            InlineKeyboardButton('𝚂𝚃𝙰𝚃𝚄𝚂', callback_data='stats'),
            InlineKeyboardButton('𝙽𝙴𝚇𝚃 ››', callback_data='help')  
         ]] 
        reply_markup = InlineKeyboardMarkup(buttons)             
        await query.message.edit_text(                     
        ...
        buttons = [[                               
            ...
            InlineKeyboardButton('𝙿𝙰𝚂𝚃𝙴', callback_data='purges'),                          
            ...
            InlineKeyboardButton('𝙽𝙴𝚇𝚃 ››', callback_data='help3')
         ]]
        reply_markup = InlineKeyboardMarkup(buttons)             
        await query.message.edit_text(                     
            text=script.HELP_TXT.format(query.from_user.mention),
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝚄𝚁𝙻_𝚂𝙷𝙾𝚁𝚃', callback_data='urlshort'),
            ...
            InlineKeyboardButton('𝙳𝙴𝙿𝙻𝙾𝚈​', callback_data='suneesh'),
        ...
        buttons= [[
            InlineKeyboardButton('⌬ 𝚄𝙿𝙳𝙰𝚃𝙴𝚂', url='https://t.me/cinema_flix_updates'),
        ...
        buttons = [[
            InlineKeyboardButton('‹‹𝙱𝙰𝙲𝙺', callback_data='start'),
            InlineKeyboardButton('☏𝙲𝙾𝙽𝚃𝙰𝙲𝚃', url='https://t.me/MalluBlasters')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('𝚁𝙴𝙿𝙾', url='https://t.me/cinema_flix_updates'),
            InlineKeyboardButton('𝙾𝚆𝙽𝙴𝚁', url='https://t.me/dz_offline_tg')
            ],[
            InlineKeyboardButton('‹‹𝙱𝙰𝙲𝙺', callback_data='help3')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('⚙️𝙰𝙳𝙼𝙸𝙽 𝙾𝙽𝙻𝚈⚙️', callback_data='admin')
            ],[
            InlineKeyboardButton('‹‹𝙱𝙰𝙲𝙺', callback_data='help2')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text="❗️╳ 𝗡𝗼 𝗠𝗼𝗿𝗲 𝗣𝗮𝗴𝗲𝘀 𝗔𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 ╳❗️", callback_data="pages")]
        )   
    ...
    if imdb and imdb.get('poster'):
        try:
            await message.reply_photo(photo=imdb.get('poster'), reply_markup=InlineKeyboardMarkup(btn))
